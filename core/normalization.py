...
PURCHASE_ALIASES: Mapping[str, Iterable[str]] = {
    ...
    "current_supplier": ["supplier", "vendor", "current supplier", "distributor"],
    "distributor_item_number": [
        "dist item #",
        "dist. item #",
        "supplier sku",
    ...
    "manufacturer": ["mfg", "manufacturer", "brand", "maker"],
    "manufacturer_item_number": [
        "mfg item #",
        "manufacturer sku",
    ...
    "quantity": ["qty", "quantity", "order qty", "units purchased"],
    "uom": ["uom", "unit", "unit of measure", "pack", "package"],
    "current_unit_price": ["unit price", "price", "current unit price", "each price"],
    "old_spend": ["total spend", "amount", "extended price", "old spend", "spend", "ext price"],
    "last_order_date": ["last purchase date", "last order date", "purchase date", "date"],
